...
public sealed class SqlServerTarget : IDisposable
{
    ...
    private Lazy<IEnumerable<Urn>> _userObjectUrns => new(()
        ...
        .Union(AddUrns<SqlAssembly>(_database.Assemblies, r => !r.IsBuiltInAssembly()))
        ...
        .Union(AddUrns<Sequence>(_database.Sequences))
        .Union(AddUrns<Rule>(_database.Rules))
        .Union(AddUrns<Default>(_database.Defaults))
        .Union(AddUrns<DatabaseRole>(_database.Roles))
        .Union(AddUrns<ApplicationRole>(_database.ApplicationRoles))
        .Union(AddUrns<User>(_database.Users, t => t.IsSystemObject))
        .Union(AddUrns<Synonym>(_database.Synonyms))
